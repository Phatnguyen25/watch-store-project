...
urlpatterns = [
    ...
    path('product/<int:product_id>/review/', product_views.add_product_review, name='add_product_review'),
    ...
    path('dashboard/products/template/', staff_required(dashboard_views.download_product_template), name='download_product_template'),
    path('dashboard/stock/history/', staff_required(dashboard_views.dashboard_stock_history), name='dashboard_stock_history'),
    path('dashboard/stock/history/<int:pk>/', staff_required(dashboard_views.dashboard_stock_history_detail), name='dashboard_stock_history_detail'),
    ...
    path('dashboard/orders/detail/<int:pk>/', staff_required(dashboard_views.dashboard_order_detail), name='dashboard_order_detail'),
